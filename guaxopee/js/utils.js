...
function criarCardProduto(produto) {
  ...
  card.innerHTML = `
    <a href="produto.html?id=${produto.id}" class="card-produto__link" aria-label="Ver ${escapeHtml(produto.nome)}">
      ...
      <div class="card-produto__corpo">
        ...
        <div class="card-produto__precos">
          ${produto.precoAnterior ? `<span class="card-produto__preco-anterior">${formatarPreco(produto.precoAnterior)}</span>` : ""}
    ...
    <button type="button" class="btn btn--primary btn--full card-produto__cta" data-ver-shopee="${produto.id}">
      Ver na Shopee →
    </button>
  `;
