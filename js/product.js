    ...
    <div class="produto-detalhe">
      ...
      <div>
        ...
        <div class="produto-detalhe__precos">
          ${produto.precoAnterior ? `<span class="produto-detalhe__preco-anterior">${formatarPreco(produto.precoAnterior)}</span>` : ""}
          <span class="produto-detalhe__preco">${formatarPreco(produto.preco)}</span>
        ...
        <button type="button" class="btn btn--primary btn--lg btn--full" data-ver-shopee>
